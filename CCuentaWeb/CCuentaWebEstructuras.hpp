...
struct SMaestroDetalle
{
	...
	SMaestroDetalle()
	{
		memset(this, 0, sizeof(SMaestroDetalle) - sizeof(SqlTimeStamp));
...
struct SCuentaPerdidaDetalle
{
	...
	{
		memset(this, 0, sizeof(SCuentaPerdidaDetalle) - sizeof(SqlTimeStamp)*2);
		cFechaUltimaCompra.ponerFecha(1, 1, 1900);
...
struct CCuentaClienteWeb
{
	...
	CCuentaClienteWeb()
	{
		memset(this, 0, sizeof(CCuentaClienteWeb) - (sizeof(SMaestroDetalle)*NUM_CTAS_DETALLE) - (sizeof(SCuentaPerdidaDetalle)*NUM_CTAS_DETALLE) - (sizeof(SqlTimeStamp)*16));
...
struct CInfoClienteWeb
{
	...
	CInfoClienteWeb()
	{
		memset(this,0,sizeof(CInfoClienteWeb)-(sizeof(SqlTimeStamp)*2));
...
struct CDomicilioWeb
{
	...
	CDomicilioWeb()
	{
        memset(this, 0, sizeof(CDomicilioWeb));
	};
...
struct CParametricosWeb
{
	...
	CParametricosWeb()
	{
        memset(this, 0, sizeof(CParametricosWeb) - sizeof(SqlTimeStamp));
...
struct CLineaCreditoWeb
{
	...
	CLineaCreditoWeb()
	{
		memset(this, 0, sizeof(CLineaCreditoWeb)-(sizeof(SqlTimeStamp)*2) );
...
struct CCuentaTotalesWeb
{
	...
	CCuentaTotalesWeb( )
	{
		memset( this, 0, sizeof( CCuentaTotalesWeb ) );
	};
};
...
struct CPrestamosWeb
{
	...
	CPrestamosWeb( )
	{
		memset( this, 0, sizeof( CPrestamosWeb ) );
	};
};
...
struct CConveniosWeb
{
	...
	CConveniosWeb( )
	{
		memset( this, 0, sizeof( CConveniosWeb ) - sizeof(SqlTimeStamp) );
...
struct CAumentoLRCWeb
{
	...
	CAumentoLRCWeb( )
	{
		memset( this, 0, sizeof( CAumentoLRCWeb ) );
	};
};
...
struct SInfoReestructura
{
	...
	SInfoReestructura( )
	{
		memset( this, 0, sizeof( SInfoReestructura ) );
	};
};
...
struct CBonificacionPrestamo
{
	...
	{
		memset( this, 0, sizeof( CBonificacionPrestamo ) );
	};
};