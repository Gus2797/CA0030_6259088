...
JsonAbonoMotosC::JsonAbonoMotosC(void)
{
}
...
void JsonAbonoMotosC::agregarAbono(int tienda, int ciudad, long cliente, int caja, long importe, int meses,
...
std::string JsonAbonoMotosC::getJson() const {
