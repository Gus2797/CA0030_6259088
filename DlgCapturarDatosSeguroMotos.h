...
class CDlgCapturarDatosSeguroMotos : public CDialog2012
{
    DECLARE_DYNAMIC(CDlgCapturarDatosSeguroMotos)

public:
    CDlgCapturarDatosSeguroMotos(CWnd* pParent = NULL);   // standard constructor
    virtual ~CDlgCapturarDatosSeguroMotos();
    ...
    int mesesAbonar(int i, int iMesEdad);
    ...
    int iControles, iFoco, iMeses, iSeguros, iEsSeguroClub, iCaja, iMuestraMsg, iFlagBanorte,
        ...
        iFlagSeguroAdicional, iEdadCliente, iPuntualidad, iTienda, iOrigenSeguro, iProcesoBeneficiariosAdicionales, iNumSegurosNuevo, iCiudad, iNumeroMeses;
    ...
    // Dialog Data
    enum { IDD = IDD_DLGCAPTURARDATOSSEGUROMOTOS };
