...
SELECT * FROM logbonificaciondiaria;

DELETE FROM logbonificaciondiaria;

SELECT * FROM fun_guardarlogbonificaciondiaria
(10203, 240340, 'este es el log....', '2025-08-20', 803, 'este log viene de.....');